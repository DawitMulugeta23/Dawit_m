  ...
  return (
    ...
    >
        ...
        <div className="hidden md:flex space-x-6 font-bold text-sm uppercase tracking-widest">
          {navItems.map((item) => (
            <a
              ...
              className={`${
                activeSection === item ? "text-blue-600" : "opacity-60"
      ...
      <div
        ...
        ${
          darkMode
            ? "bg-[#0f172a] border-slate-700" // ሙሉ በሙሉ Solid color (Slate 900)
            : "bg-white border-gray-200" // ሙሉ በሙሉ Solid White
        }`}
      >
      ...
      {/* Dark background layer when menu is open (Optional - to focus on menu) */}
      {isOpen && (
        <div
